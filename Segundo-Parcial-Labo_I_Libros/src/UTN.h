...
/**
 * \fn char menuGenericoChar(char[])
 * \brief funcion menu que retorna un char
 *
 * \param opciones char[]
 * \return char
 */
 ...
 * @brief pide el ingreso de cadena de caracteres validando que no sea un numero.
 *
 * @param palabra char[]
 * @param mensaje char[]
 * @param tamanio int
 ...
 * \brief valida que no se ingrese espacio en el indice 0, y mas de dos continuos
 *
 * \param str char[]
 * \return int
 */
